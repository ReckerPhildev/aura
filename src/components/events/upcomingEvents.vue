  ...
  <v-container class="pa-0">
    ...
    >
      <v-flex xs12 md12 lg12 class="pa-2 mb-0">
        <p class="google-font mb-0" style="font-size: 170%; color: #0277bd">
          Upcoming Events
        </p>
    ...
    >
      ...
      <v-flex xs12 v-if="notFoundUpcomingEventFlag == true">
        <p class="google-font px-2" style="font-size: 140%">
          <v-icon></v-icon>Check out our upcoming and directory of our past events...
          <a href="https://gdsc.community.dev/kabarak-university/">Visit GDSC Kabarak University</a>
        </p>
